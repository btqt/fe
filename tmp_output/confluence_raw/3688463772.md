...
**│   └── IAudioManagerService\_socket.h**  
├── interface/  
│   ├── AudioManager.cpp  
│   ├── IAudioManagerReceiver.cpp  
│   ├── IAudioManagerService.cpp│   └── **interface\_socket/  
│          ├── IAudioManagerService\_socket.cpp  
│          └── IManagerService\_socket.cpp**  
├── service/  
│   ├── AudioAdaptee.cpp  
│   ├── AudioAdaptee.h  
